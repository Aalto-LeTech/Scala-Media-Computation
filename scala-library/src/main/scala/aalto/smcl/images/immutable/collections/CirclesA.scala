package aalto.smcl.images.immutable.collections

import aalto.smcl.images.immutable.primitives.{Bitmap, Circle}
...
import aalto.smcl.images.immutable.primitives.Bitmap.ViewerUpdateStyle.PreventViewerUpdates
