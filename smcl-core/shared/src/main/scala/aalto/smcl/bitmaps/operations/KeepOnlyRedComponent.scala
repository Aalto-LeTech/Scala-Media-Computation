...
/**
 * Operation to keep only the red component of a bitmap.
 *
 * @author Aleksi Lukkarinen
 */
private[bitmaps]
case class KeepOnlyRedComponent()
    extends AbstractOperation
            with OneSourceFilter
            with Immutable {

  /** First text paragraph of the description of this class. */
  val descriptionTitle: String = "KeepOnlyRedComponent"
  ...
  override protected def createStaticBuffer(sources: BitmapBufferAdapter*): BitmapBufferAdapter = {
    ...
    sources(0).createFilteredVersionWith(ColorComponentTranslationTable.forKeepingOnlyRed)
  }
