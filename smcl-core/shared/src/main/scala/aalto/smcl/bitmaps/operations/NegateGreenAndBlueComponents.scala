...
/**
 * Operation to negate the green and blue components of a bitmap.
 *
...
case class NegateGreenAndBlueComponents()
  ...
  lazy val metaInformation = MetaInformationMap("NegateGreenAndBlueComponents", Map())
  ...
  override protected def createStaticBuffer(sources: BitmapBufferAdapter*): BitmapBufferAdapter = {
    ...
    sources(0).createFilteredVersionWith(RGBAComponentTranslationTable.forNegatingGreenAndBlue)
  }
