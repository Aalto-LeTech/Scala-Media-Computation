...
package aalto.smcl.colors.hsv.exceptions
 ...
 */
final case class SaturationComponentOutOfRangeError private[smcl](
    invalidValue: Double, minimumValue: Double, maximumValue: Double)
    extends SMCLBaseError(
      "The HSV saturation component value of a color was out of its range " +
