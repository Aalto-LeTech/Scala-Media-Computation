 ...
 */
final case class NormalizedRGBAOpacityComponentOutOfRangeError private[smcl](
    invalidValue: Double, minimumValue: Double, maximumValue: Double)
    extends SMCLBaseError(
      "The normalized RGB opacity component of a given color was out of its Double range " +
