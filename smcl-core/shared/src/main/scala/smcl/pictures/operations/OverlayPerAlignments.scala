...
import smcl.infrastructure.{BitmapBufferAdapter, PRF}
import smcl.modeling.Len
import smcl.pictures.fullfeatured.AbstractBitmap
import smcl.settings.{HorizontalAlignment, VerticalAlignment, _}
...
case class OverlayPerAlignments(
   ...
   * a [[smcl.infrastructure.BitmapBufferAdapter]] instance always after
   * instantiation of the class claiming to provide the buffer.
   *
