...
import smcl.colors.hsi.exceptions.{IntensityComponentOutOfRangeError, SaturationComponentOutOfRangeError}
import smcl.colors.hsv.exceptions.{SaturationComponentOutOfRangeError, ValueComponentOutOfRangeError}
import smcl.colors.rgb.exceptions.{BlueComponentOutOfRangeError, GreenComponentOutOfRangeError, RedComponentOutOfRangeError}
...
object ColorValidator {
  ...
  val RedRange: Range.Inclusive = ByteRange
  ...
  val GreenRange: Range.Inclusive = ByteRange
  ...
  val BlueRange: Range.Inclusive = ByteRange
  ...
  val GrayRange: Range.Inclusive = ByteRange
  ...
  val OpacityRange: Range.Inclusive = ByteRange
