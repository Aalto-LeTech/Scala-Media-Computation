 ...
 *
 */
object InvalidColorComponentArrayLengthError {
   ...
   * @return
   */
  def apply(message: String): InvalidColorComponentArrayLengthError =
    InvalidColorComponentArrayLengthError(message, null)
