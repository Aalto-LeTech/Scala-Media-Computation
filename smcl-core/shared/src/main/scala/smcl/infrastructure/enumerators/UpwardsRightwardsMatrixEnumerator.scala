 ...
 */
object UpwardsRightwardsMatrixEnumerator
  ...
  def instantiateEnumerator(
    ...
    new UpwardsRightwardsMatrixEnumerator(
      upperLeftColumn,
      upperLeftRow,
      lowerRightColumn,
      lowerRightRow)
 ...
 * @author Aleksi Lukkarinen
 */
class UpwardsRightwardsMatrixEnumerator private(
  ...
  def enumerationState: MatrixEnumerator2DInternalEnumerationState =
    new MatrixEnumerator2DInternalEnumerationState {
      ...
      def hasNextCell: Boolean =
        currentColumn < lowerRightColumn || currentRow > upperLeftRow
