...
package object bitmaps
  ...
  val Bitmap: simplified.Bitmap.type = simplified.Bitmap

  /** A type alias for . */
  type Bmp = fullfeatured.Bmp

  /** A companion object alias for . */
  val Bmp: fullfeatured.Bmp.type = fullfeatured.Bmp

  /** A type alias for . */
  type Image = fullfeatured.Image

  /** A companion object alias for . */
  val Image: fullfeatured.Image.type = fullfeatured.Image

  /** A type alias for . */
  type Point = fullfeatured.Point

  /** A companion object alias for . */
  val Point: fullfeatured.Point.type = fullfeatured.Point

  /** A type alias for . */
  type Line = fullfeatured.Line

  /** A companion object alias for . */
  val Line: fullfeatured.Line.type = fullfeatured.Line
