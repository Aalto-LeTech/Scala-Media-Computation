...
import smcl.bitmaps.fullfeatured.{AbstractBitmap, BitmapCompanion}
import smcl.bitmaps.operations._
import smcl.bitmaps.{BitmapValidator, ConvolutionKernel, PixelSnapshot, PixelSnapshotReceiver}
import smcl.colors.ColorValidator
import smcl.colors.rgb.{Color, ColorComponentTranslationTable}
import smcl.infrastructure.{BitmapBufferAdapter, Identity, OneHalfOfCircleInDegrees, OneQuarterOfCircleInDegreesClockwise, OneQuarterOfCircleInDegreesCounterClockwise}
