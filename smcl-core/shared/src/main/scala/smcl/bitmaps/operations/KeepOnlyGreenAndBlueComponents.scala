...
case class KeepOnlyGreenAndBlueComponents()
  ...
  val descriptionTitle: String = "KeepOnlyGreenAndBlueComponents"
  ...
  override protected def createStaticBuffer(sources: BitmapBufferAdapter*): BitmapBufferAdapter = {
    ...
    sources(0).createFilteredVersionWith(ColorComponentTranslationTable.forKeepingOnlyGreenAndBlue)
  }
